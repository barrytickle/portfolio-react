            ...
            <section className="section--large">
                <div className="container">
                    <MediaText media={<GallerySlider images={galleryImages}/>}>
                        <h2>My portfolio</h2>
                        <p>My projects <span className="faded-text">show what I can achieve as an individual, a project should be developed with the user in mind.</span></p>
                        <hr className="large-spacing"/>
                        <p>As a web designer <span className="faded-text">user interaction is one of my main aims when visiting a website, making a website look good should only be the first steps of developing a system for users.</span></p>
                    </MediaText>
                    <MediaText imagePosition="right" media={<img src="/public/assets/images/photography/manchester.webp"/>}>
                        <h2>My photography</h2>
                        <p>Photography <span className="faded-text">has always been a huge interest of mine, I like to travel quite a lot and capturing memories of amazing scenery feels like more than just a hobby to me. I like being able to capture pictures of buildings at interesting angles which can capture the most detail. I love being able to find the history in scenery and monuments.</span></p>
                    </MediaText>
                </div>
            </section>
        </>
